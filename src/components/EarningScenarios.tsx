...
export default function EarningScenarios() {
  // Track flip state for each card by index
        ...
        {scenarios.map((item, i) => {
          ...
          return (
            <motion.div
              ...
              tabIndex={0}
              role="button"
              aria-label={`${item.role} details card. Click or hover to flip.`}
              onKeyDown={(e) => {
            ...
            >
              {/* Framer Motion 3D Animated Card */}
              <motion.div
              ...
              >
                ...
                >
                  ...
                  <div className="pt-4 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between text-xs font-bold text-blue-600 dark:text-blue-400">
                    <span>Click or hover to flip 3D</span>
